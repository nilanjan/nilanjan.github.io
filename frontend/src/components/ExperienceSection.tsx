            ...
            >
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                  ...
                  <div className="space-y-2 text-sm text-dark-600 dark:text-gray-300">
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-dark-900 dark:text-white mb-3 flex items-center">
                    ...
                    <ul className="space-y-2">
                      {exp.achievements.map((achievement, idx) => (
                        <motion.li
                          ...
                          viewport={{ once: true }}
                          className="flex items-start text-dark-600 dark:text-gray-300"
                        >
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-dark-700 dark:text-gray-300 mb-2">
                      Technologies & Skills:
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {exp.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-3 py-1 bg-gray-100 dark:bg-dark-700 text-dark-700 dark:text-gray-300 text-xs font-medium rounded-full"
                        >
                          {tech}
                        </span>
                      ))}
          ...
          <div className="bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div>
                ...
                <div className="text-sm text-dark-600 dark:text-gray-300">Years Experience</div>
              </div>
              <div>
                <div className="text-3xl font-bold gradient-text mb-2">16+</div>
                <div className="text-sm text-dark-600 dark:text-gray-300">Patents</div>
              </div>
              <div>
                <div className="text-3xl font-bold gradient-text mb-2">20+</div>
