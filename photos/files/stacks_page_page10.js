...
stacks.stacks_in_9_page10 = {};
stacks.stacks_in_9_page10 = (function(stack) {
...
$(function() {
    ...
    */
    ...
    var initializeLibraries = function(images, allowImageShuffle, initializeLightbox) {
        if (images.length > 0) {
            ...
            if (stacks['stacks_in_9_page10'].initializeGrid) {
                stacks['stacks_in_9_page10'].initializeGrid('.stacks_in_9_page10_photo_wrapper', images, function () {
                    if (initializeLightbox) {
                        if (stacks['stacks_in_9_page10'].initializeLightbox) {
                            stacks['stacks_in_9_page10'].initializeLightbox('.stacks_in_9_page10_photo_wrapper', images, function () {
                                //$('#stacks_in_9_page10').toggle();
            ...
            if (stacks['stacks_in_9_page10'].initializeSlider) {
                stacks['stacks_in_9_page10'].initializeSlider('.stacks_in_9_page10_photo_wrapper', images, function () {
                    //$('#stacks_in_9_page10').toggle();
                });
            }
        }
    ...
    stacks['stacks_in_9_page10'].refreshLibraries = initializeLibraries;

    var images = [];
    // Synchrounous
    $.each($('.stacks_in_9_page10_photo_wrapper').children(), function(){
        ...
        // Pulse CMS Blog Gallery
            ...
            $.each($('#stacks_in_1_page10 img').css("display","none"), function() {
                images.push({
                    imgLgSrc:      this.src,
                    imgLgCaption: this.alt,
                    imgSmSrc:      this.src,
    ...
    if (stacks['stacks_in_9_page10'].asyncImageSource) {
        stacks['stacks_in_9_page10'].asyncImageSource(images, function (images) {
...
return stack;})(stacks.stacks_in_9_page10);
stacks.stacks_in_10_page10 = {};
stacks.stacks_in_10_page10 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;stacks['stacks_in_9_page10'].initializeGrid = function(selector, images, completeCallback) {
	var html = [];
...
return stack;})(stacks.stacks_in_10_page10);
stacks.stacks_in_26_page10 = {};
stacks.stacks_in_26_page10 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;stacks['stacks_in_9_page10'].initializeLightbox = function(selector, images, completeCallback) {
	$(selector).lightGallery({
		selector: 'a'
	});
	completeCallback();
};
return stack;})(stacks.stacks_in_26_page10);